...
Option 1: Full 24-module online including all eBooks -- full GBP1,399, beta GBP695
Option 2: Full 24-module + fortnightly live group coaching -- full GBP1,998, beta GBP999
Option 3: Full 24-module + fortnightly group + monthly 1-to-1 via Zoom -- full GBP3,999, beta GBP1,998
Option 4: Full 24-module + fortnightly group + weekly 1-to-1 via Zoom -- full GBP6,999, beta GBP4,999
Option 5: Full 24-module + individual weekly coach -- full GBP14,999, beta GBP9,999
Option 6: Personal tuition with PJW via Zoom -- full GBP29,999, beta GBP19,999
Option 7: First 12 modules + 5 of your choice -- full GBP999, beta GBP495
Option 8: First 12 modules + 5 more + fortnightly group coaching -- full GBP1,599, beta GBP999
...
Brain Booster Guides: GBP1.99-GBP2.99, 318 topics
eBooks: GBP7.99-GBP9.99
Online modules: GBP39 each
Initial Assessment with human coach: GBP150 for 90 minutes via Zoom
1-to-1 coaching: GBP100/hr online, up to GBP250 for 90-minute intensive
Gen Z Career Programme: from GBP3,000
AI App subscription: GBP29-GBP39/month, minimum 3 months recommended
...
Executives: 1-to-1 coaching GBP100-GBP250/hr via Zoom + Mastery Options 3-4
Athletes: Peak Performance Coaching + Mind Flow for Golfers eBook GBP7.99 + Sport Guide
Neurodiversity: Neurodiversity coaching + ADHD guides GBP1.99 + Mastery Module 20
...
Students: Brain Booster guides + modules GBP39 each
Gen Z: Gen Z Career Programme from GBP3,000 + App subscription GBP29-GBP39/month
General/new: Free book + Self-Audit + Mastery Option 1 beta GBP695
 
Always offer something at every price point -- from free to GBP19,999.
...
Option 1 -- Continue with WIZ on the App: We can build on everything from today in follow-up sessions, each one going deeper into the areas that matter most to you, building an evolving personal programme over time. An App subscription gives you ongoing access for GBP29-GBP39 per month -- and every session builds on the last.
 
Option 2 -- Work with a Mind Flow coach one-to-one: This is where the most powerful transformation happens -- completely personalised, human, delivered via Zoom at a time that suits you, and built specifically around your life and goals. Nothing is generic. Everything is yours. The Mind Flow Mastery Programme starts at GBP695 in beta. An Initial Assessment session is GBP150 for 90 minutes, with no commitment until a programme is agreed.
...
<div class="app">
  <aside class="sidebar">
    ...
    <div class="sidebar-section">
      ...
      <p style="font-size:11px;color:rgba(255,255,255,0.38);line-height:1.6">Ready to go deeper? Book an Initial Assessment with a qualified Mind Flow coach -- 90 minutes via Zoom, GBP150, no commitment.</p>
...
function startSession() {
  var t = "Hello, and welcome to your Mind Flow session. I am really glad you are here today.\n\nI am WIZ -- the Mind Flow AI Coaching Agent, built on the methodology of PJ Wingfield and the Mind Flow International team -- over 35 years of coaching, research, and genuine belief that every person is capable of more than they currently demonstrate.\n\nMind Flow is the practised ability to access a state of effortless focus, calm confidence, and accelerated performance -- at will.\n\nOne important note: I am a coaching intelligence, not a therapist or clinician. This session is completely yours. No wrong answers, no judgements -- just a real conversation about where you are and where you want to go.\n\nSo -- to start. What is your name?";
